...
def clone_voice(src_voice:str, ref_voice:str, output_dir, diffusion_steps:int = 30,
    ...
    fname = os.path.join(output_dir, f"vc_{source_name}_{target_name}_{length_adjust}_{diffusion_steps}_{inference_cfg_rate}.wav")
    torchaudio.save(fname,vc_wave.cpu(), sr)
    return fname


if __name__ == "__main__":
    clone_voice(src_voice='/Users/neuralgarage/Documents/Repos/seed-vc/data/temp.wav', ref_voice='/Users/neuralgarage/Documents/Repos/seed-vc/data/Mithali-cloned-V2-cropped.wav'
                , output_dir='/Users/neuralgarage/Documents/Repos/seed-vc/data/')
